	...
	public ZipDemoForParGraphVars(){
		...
		jbAdd.addActionListener(new ActionListener(){	//增加文件按钮事件处理
			public void actionPerformed(ActionEvent event) {
				if (fileChooser.showOpenDialog(ZipDemoForParGraphVars.this)==JFileChooser.APPROVE_OPTION){	//弹出文件选择器,并判断是否点击了打开按钮
...
//	}
	...
	private void showMessage(String message){
		JOptionPane.showMessageDialog(ZipDemoForParGraphVars.this,message); //显示信息
	}
